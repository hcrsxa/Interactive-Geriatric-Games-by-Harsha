...
namespace OpenCVForUnity.UnityIntegration.Worker.DnnModule
{
    ...
    /// </summary>
    public class NanoDetPlusObjectDetector : DnnInferenceWorkerBase
    {
        ...
        protected override Mat[] RunCoreProcessing(Mat[] inputs)
        {
            ...
            // Postprocess
            Mat submat = PostProcess(_forwardOutputList[0], image.sizeAsValueTuple()); // submat of _output0Buffer is returned
        ...
        protected override async Task<Mat[]> RunCoreProcessingTaskAsync(Mat[] inputs, CancellationToken cancellationToken)
        {
            ...
            if (_objectDetectionNet.UsesSentis)
            {
                ...
                Mat submat = PostProcess(_forwardOutputList[0], image.sizeAsValueTuple());
